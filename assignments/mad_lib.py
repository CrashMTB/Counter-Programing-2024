...
#the end
creature = input("name a random creature/animal\n> ")
name = input("enter a name for the main charecter\n> ")
object = input("give me any object\n> ")
adjective = input("give me a random adjective \n> ")
adjective2 = input("give me a random adjective \n> ")
creature2 = input("give me a mythical creature\n> ")
city = input("what is the name of a city\n> ")
creature3 = input("give me a mythical creature\n> ")
emotion = input("name any stong emotion\n> ")
celeberty = ("name every celeberty")